# ICOIP AI Training & Curriculum Development Portal

This folder is a ready-to-paste **Google Apps Script web app** for the **AI Training & Curriculum Development Portal** under the **Integrated Care & Operations Intelligence Programme (ICOIP)**.
