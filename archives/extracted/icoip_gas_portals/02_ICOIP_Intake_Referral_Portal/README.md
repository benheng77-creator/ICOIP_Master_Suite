...
This folder is a ready-to-paste **Google Apps Script web app** for the **Intake & Referral Portal** under the **Integrated Care & Operations Intelligence Programme (ICOIP)**.
