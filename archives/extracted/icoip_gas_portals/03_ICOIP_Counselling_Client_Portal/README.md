# ICOIP Counselling & Client Portal

This folder is a ready-to-paste **Google Apps Script web app** for the **Counselling & Client Portal** under the **Integrated Care & Operations Intelligence Programme (ICOIP)**.
